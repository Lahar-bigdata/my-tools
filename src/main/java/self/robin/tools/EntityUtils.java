...
public class EntityUtils {
    ...
    public static <R> R getSafely(Supplier<R> func) {
        try {
            ...
            Logger.getLogger(EntityUtils.class.getSimpleName()).warning(e.getMessage());
            return null;
        }
    }
    ...
    public static String underscoreToCamelCase(String name) {
        ...
        do {
            ...
            if (index < name.length()) {
                ...
                if (startIndex != 0) {
                    subStr = firstLetterToUpper(subStr);
                }
     ...
     * @return
     */
    public static final String firstLetterToUpper(String str) {
