package self.robin.asm; /**
 * @author Li Yalei - Robin
 * @since: 2021/8/6 18:36
 */
...
@SupportedAnnotationTypes("self.robin.asm.Data2")
...
public class MyDataAnnotationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        // 获取注解类的集合，之后依次去处理
        Set<? extends Element> set = roundEnv.getElementsAnnotatedWith(Data2.class);
